; Copyright (c) 2018, Erik Lundin.
    ...
    global  xx__chacha_avx


; An optimized implementation of our ChaCha core function, utilizing the AVX
...
.lr:
    ...
    vpshufb     xmm12, xmm12, [rel rol16]
    vpshufb     xmm13, xmm13, [rel rol16]
    vpaddd      xmm2, xmm2, xmm6
    vpaddd      xmm3, xmm3, xmm7
    vpxor       xmm14, xmm14, xmm2
    vpxor       xmm15, xmm15, xmm3
    vpshufb     xmm14, xmm14, [rel rol16]
    vpshufb     xmm15, xmm15, [rel rol16]
    vmovdqa     [rsp], xmm0
    vmovdqa     [rsp + 16], xmm2
    ...
    vpxor       xmm12, xmm12, xmm0
    vpxor       xmm13, xmm13, xmm1
    vpshufb     xmm12, xmm12, [rel rol8]
    vpshufb     xmm13, xmm13, [rel rol8]
    vpaddd      xmm2, xmm6, [rsp + 16]
    vpaddd      xmm3, xmm3, xmm7
    vpxor       xmm14, xmm14, xmm2
    vpxor       xmm15, xmm15, xmm3
    vpshufb     xmm14, xmm14, [rel rol8]
    vpshufb     xmm15, xmm15, [rel rol8]
    vmovdqa     [rsp], xmm2
    vpaddd      xmm8, xmm8, xmm12
    vpaddd      xmm9, xmm9, xmm13
    vpxor       xmm4, xmm4, xmm8
